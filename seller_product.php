...
if (isset($_POST['add_product'])) {
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        $add_product_query = mysqli_query($conn, "INSERT INTO `products`(user_id,name, price, image) VALUES('$user_id','$name', '$price', '$image')") or die('query failed');
        ...
        <div class="box-container">
            ...
            if (mysqli_num_rows($select_products) > 0) {
                while ($fetch_products = mysqli_fetch_assoc($select_products)) {
                    // 
              $_SESSION["book_name"] = $fetch_products['name'];
            //   
            ...
            ?>
                    <div class="box">
                        ...
                        <a href="seller_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
                    </div>
            <?php
                }
            } else {
